...
function getwords() {
  ...
  switch (monthday) {
    ...
    case 119: return ["point", "cheap", "extra", "tiger", "scout"];
    case 120: return ["zippy", "payer", "dimly", "eagle", "ranch"];
    case 121: return ["owner", "score", "basil", "civic", "input"];
    case 122: return ["wharf", "bliss", "adorn", "plain", "merry"];
    case 123: return ["bebop", "field", "sleet", "shyly", "oldie"];
    case 124: return ["axial", "growl", "drawl", "champ", "train"];
    case 125: return ["broad", "agree", "swirl", "mount", "folio"];
    case 126: return ["finch", "shrug", "comer", "heavy", "globe"];
    case 127: return ["twirl", "gamut", "candy", "shame", "study"];
    case 128: return ["merry", "creek", "paper", "lever", "testy"];
    case 129: return ["alley", "delta", "niche", "bogey", "dryly"];
    case 130: return ["trail", "dazed", "wonky", "molly", "tenth"];
    case 131: return ["foggy", "divvy", "askew", "gluon", "whisk"];
    case 200: return ["xylem", "holly", "coupe", "lymph", "edict"];
    case 201: return ["wacko", "drake", "kaput", "sassy", "depth"];
    case 202: return ["ruddy", "flint", "ditch", "droop", "sling"];
